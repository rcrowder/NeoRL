	...
	std::mt19937 &rng)
{
    ...
    neo::enqueueFillImage(cs, vl._actions, zeroColor, zeroOrigin, { static_cast<cl::size_type>(vld._size.x), static_cast<cl::size_type>(vld._size.y), 1 });
    neo::enqueueFillImage(cs, vl._actionsExploratory, zeroColor, zeroOrigin, { static_cast<cl::size_type>(vld._size.x), static_cast<cl::size_type>(vld._size.y), 1 });
  ...
  neo::enqueueFillImage(cs, _qStates[_back], zeroColor, zeroOrigin, qRegion);
